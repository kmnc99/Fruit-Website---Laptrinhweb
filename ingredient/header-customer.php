...
<header class="header">
        <div class="header_body">
                ...
                <nav class="navbar">
                    ...
                    <li><a class="detail" href="shop_products.php">Cửa hàng</a></li>
                    <li class=" dropdown detail ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link detail-nav" href="shop_products.php">Trái cây nhiệt đới</a></li>
                            <li><a class="nav-link detail-nav" href="shop_products.php">Trái cây nhập khẩu</a></li>
                            <li><a class="nav-link detail-nav" href="shop_products.php">Giỏ trái cây</a></li>
                        </ul>
                    </li>
            ...
            <form class="d-flex search" role="search" style="margin-left:30px">
                ...
                <button type="submit"><i style="font-size: 26px;margin-top:2px" class='bx bx-search seachh'></i></button>
            ...
            <div class="cartt">
                ...
                <a class="cart" href=""><box-icon name='log-out'><?php if(isset($_SESSION['dangnhap'])){
