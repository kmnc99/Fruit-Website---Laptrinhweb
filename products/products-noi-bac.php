...
<h3 class="title-comm"><span class="title-holder">SẢN PHẨM NỔI BẬC</span></h3>
            <div class="product_container">
                <?php 
                $select_products = mysqli_query($conn,"Select * from `products-noi-bac`");
            ...
            <?php
            // Hiển thị các chức năng mua hàng
            //echo "<p>Chức năng mua hàng</p>";

            // Kiểm tra xem người dùng đã đăng nhập hay chưa
            //if (!isset($_SESSION['user_id'])) {
                // Nếu chưa đăng nhập, hiển thị thông báo và liên kết đến trang đăng nhập
                //echo "<p>Bạn cần đăng nhập để mua hàng. <a href='login.php'>Đăng nhập</a></p>";
            //} else {
                // Nếu đã đăng nhập, hiển thị các chức năng mua hàng
                //echo "<p>Chức năng mua hàng</p>";
            //}
    ?>
        </section>    
