...
if(isset($_POST['add_product'])){
    ...
    $insert_quert = mysqli_query($conn,"insert into `products-noi-bac`(name, price, image) values('$product_name','$product_price','$product_image')") or die("Insert query failed");
    if($insert_quert){
