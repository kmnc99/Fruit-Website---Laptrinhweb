...
if(isset($_POST['add_product'])){
    ...
    $insert_quert = mysqli_query($conn,"insert into `products-gio-qua-trai-cay`(name, price, image) values('$product_name','$product_price','$product_image')") or die("Insert query failed");
    if($insert_quert){
...
<body>
    ...
    <div class="container">
        ...
        <section>
            <h3 class="heading">Thêm Giỏ Quà trái cây</h3>
