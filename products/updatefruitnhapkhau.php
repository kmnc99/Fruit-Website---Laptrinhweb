...
if (isset($_POST['update_product'])) {
    ...
    // update query
    $update_products = mysqli_query($conn, "Update `products-nhap-khau` set name='$update_product_name', price='$update_product_price',image='$update_product_image' where id=$update_product_id");
    if($update_products)
    {
...
<body>
    ...
    <section class="edit_container">
        ...
        if(isset($_GET['edit'])){
            ...
            $edit_query = mysqli_query($conn,"SELECT * FROM `products-nhap-khau` WHERE id=$edit_id");
