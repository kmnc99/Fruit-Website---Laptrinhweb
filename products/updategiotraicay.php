...
if (isset($_POST['update_product'])) {
    ...
    // update query
    $update_products = mysqli_query($conn, "Update `products-gio-qua-trai-cay` set name='$update_product_name', price='$update_product_price',image='$update_product_image' where id=$update_product_id");
    if($update_products)
    {
...
<?php include '../admin/header_admin.php'?>
    ...
    <section class="edit_container">
        ...
        if(isset($_GET['edit'])){
            ...
            $edit_query = mysqli_query($conn,"SELECT * FROM `products-gio-trai-cay` WHERE id=$edit_id");
