...
if(isset($_POST['add_product'])){
    ...
    $insert_quert = mysqli_query($conn,"insert into `products-nhap-khau`(name, price, image) values('$product_name','$product_price','$product_image')") or die("Insert query failed");
    if($insert_quert){
...
<body>
    ...
    <div class="container">
        ...
        <section>
            <h3 class="heading">Thêm trái cây nhập khẩu</h3>
